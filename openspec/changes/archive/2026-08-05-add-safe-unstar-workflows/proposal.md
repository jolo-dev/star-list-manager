...
- Is blocked until a separate write-auth change supplies and verifies a credential that can use the REST unstar endpoint; the read-only core GitHub App token was denied this write.
